...
<head>
    ...
    <link rel="icon" href="<?php echo DIRPAGE.'lib/img/logo.png'; ?>" />
    <meta name="viewport" content="width=device-width, initial-scale=1" />
    <meta name="theme-color" content="#000000" />
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <link href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.0/css/bootstrap.min.css" rel="stylesheet" id="bootstrap-css">
    <link rel="stylesheet" href="<?php echo DIRPAGE.'lib/css/login.css'; ?>">
...
<div class="container">
        <div id="login-box">
            <div class="logo">
                <img src="<?php echo DIRPAGE.'lib/img/logo.png'; ?>" class="img img-responsive img-circle center-block" />
                <h1 class="logo-caption"><span class="tweak">L</span>ogin</h1>
            </div><!-- /.logo -->
            <div class="controls">
            <form id="formulario_login" method="post" action="controllers/funcLogin.php">
